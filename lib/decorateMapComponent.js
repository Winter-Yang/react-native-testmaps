...
//component = Callout
//return 
//AIRMapMarker   AIRGoogleMapMarker
//AIRMapCallout  AIRGoogleMapCallout
//
function getAirComponentName(provider, component) {
  console.log('********************');
  console.log(`${getAirMapName(provider)}${component}`);
  console.log('********************');
...
export default function decorateMapComponent(Component, { componentType, providers }) {
  ...
  */
  const getDefaultComponent = () =>
    //getAirComponentName(null, componentType) == 'AIRMapMarker'
    //getAirComponentName(null, componentType) == 'AIRMapCallout'
